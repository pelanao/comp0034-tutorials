...
app.layout = dbc.Card([
    ...
    dbc.CardFooter([
        html.Div(children=[
            ...
            html.Img(src='https://external-preview.redd.it/LGnb1tF60_4GoE6xQnHW2h73h_ps-zhH5__0eeq7uoY.jpg?width=640&crop=smart&auto=webp&s=05ef0aa3d17d7e9691ebdccfc3a2732cae81381a', alt='bar chart'),
